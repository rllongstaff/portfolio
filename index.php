        ...
        <section id="projects" class="section-personal-projects section-padding-small">
            ...
            <div class="row">
                ...
                <div class="col-1-of-2">
                    ...
                    <div class="btn-container">
                        <a href="https://rlongstaff-booking-system.herokuapp.com/" class="btn-small btn-small--demo" target="_blank">View Demo</a>
                        <a href="https://gomockingbird.com/projects/27k5ur6/4gXVnC" class="btn-small btn-small--mockup" target="_blank">View Mockup</a>
                        <a href="https://github.com/rllongstaff/booking-system" class="btn-small btn-small--github" target="_blank">View on GitHub</a>    
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-1-of-2">
                    ...
                    <div class="btn-container">
                        <a href="https://rlongstaff-javascript-game.herokuapp.com/Text%20Based%20Adventure/index.html" class="btn-small btn-small--demo" target="_blank">View Demo</a>
                        <a href="https://github.com/rllongstaff/javascript-game" class="btn-small btn-small--github" target="_blank">View on GitHub</a>    
                    </div>
                </div>
            </div>            
        </section>
        ...
        <div class="row">
            ...
            <div class="footer__navigation">
                <ul class="footer__list format-list-no-markers">
                    <li class="footer__item"><a href="https://www.linkedin.com/in/rlongstaff" class="footer__link footer__link--linkedin" target="_blank"><i class="fab fa-linkedin"></i></a></li>
                    <li class="footer__item"><a href="https://github.com/rllongstaff" class="footer__link footer__link--github" target="_blank"><i class="fab fa-github-square"></i></a></li>
                </ul>
            </div>
        </div>
    </footer>
